...
Comm_Error:
	...
	Public Function ReadTagRef() As Boolean
		...
		If RdInfo = "NOK" Then GoTo Comm_Error
		'UPGRADE_WARNING: Couldn't resolve default property of object Parameter.UnitModel. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
Comm_Error:
	...
	Public Function ReadTagSerial() As Boolean
		...
		If RdInfo = "NOK" Then GoTo Comm_Error
		'UPGRADE_WARNING: Couldn't resolve default property of object Parameter.UnitTagNos. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
Comm_Error:
	...
	Public Function WrTagCounter(ByRef CountVal As String) As Boolean
		Dim i, j As Integer
		Dim WrVal As String = ""
		Dim Schar As String
		Dim Ext As String = ""
	...
	Public Function Bin2Dec(ByRef Bin As String) As Double
		Dim i As Integer
	...
	Public Function Bin2Hex(ByRef Bin As String) As String
		Dim i As Object
	...
	Public Function Dec2Bin(ByRef Data As Double) As String
		Dim i As Object
	...
	Public Function Hex2Bin(ByRef Hexdata As String) As String
		Dim i As Integer
...
WRITE_COMM_TIMEOUT:
	...
	Public Function RD_MULTI_RFID(ByRef AddrNos As String, ByRef WordLength As Integer) As String
		Dim ii() As String
...
READINBYTE:
		...
		If Mid(Str1, t1 + 1, t2 - t1 - 1) = "131" Or Mid(Str1, t1 + 1, t2 - t1 - 1) = "132" Then '&H83 or &H84
			...
			GoTo Comm_Error
		End If
		For i = 1 To (WordLength * 2)
			Dim t() As Integer = {t1, t2, t3, t4, t5}
...
READ_RFID_TIMEOUT:
	...
	Public Function RD_RFID(ByRef AddrNos As String) As String
		Dim temp2 As Object
		Dim temp1 As Object
		Dim N As Object
		Dim i As Object
		...
		Dim ReadBuf As String
		Dim ValueH, ValueL As Object
		Dim CheckSum As String
		Dim Str1, Str2 As Object
		Dim BCount As Short
		Dim t3, t1, t2, t4 As Object
		Dim t5 As Short
		Dim ErrCode As String
